                            ...
                            if USE_AUDIO:
                                ...
                                subprocess.check_call(
                                    [
                                        ...
                                        'en',
                                        '--out_path',
                                        f'{GAME_PATH}/game/Submods/AI_submod/audio/out.wav',
                                    ]
                                )
                                with open(f'{GAME_PATH}/game/Submods/AI_submod/audio/out.wav', 'rb') as f:
                                    AudioSegment.from_wav(f).export(
                                        f'{GAME_PATH}/game/Submods/AI_submod/audio/out.ogg',
                                        format='ogg',
                                    )
                                os.remove(f'{GAME_PATH}/game/Submods/AI_submod/audio/out.wav')
